---
title: "Semantic Consensus and Semantic Drift - Why your institutional AI agent often goes astray"
...
3. Semantic drift must be eliminated at the offset itself. Otherwise, it can cascade across all of your business operations.

I have been working over this exact question for the past three years. What I have found is that agents fundamentally view the world differently from us because:
...
This is where it really gets interesting. If even manual approaches are not trustworthy, then what is the way to go forward? This has been one of the things that has kept me up at nights.
...
- References, which contains actual snippets or chunks or segments of unstructured and semi-structured data across all of your business data sources.
